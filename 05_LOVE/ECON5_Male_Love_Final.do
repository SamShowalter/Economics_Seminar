...
import delimited I:\17181-ECON480B\SAMUELSHOWALTER_2018\ECON5\male_love_data.csv

* get pretty reg results package
ssc install estout, replace
eststo clear

* Store regression analysis for Male Mate Preference choices in speed dating
...
title(OLS Analysis of Speed Dating and Mate Preference, Men) ///
...
drop(architecture biochemphys businessecon education engineering film fine_arts historyrel journaleng language law math medical_sc polisciintl socialwrk social_sc undecidedstud interest_corr same_race importance_race importance_religion ///
		asian black hispanic white ///
...
addnotes(Standard Errors robust. race, field, and obc others removed.)
